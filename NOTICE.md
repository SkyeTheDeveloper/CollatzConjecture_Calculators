...
2. Include a copy of the LICENSE file
3. State any significant changes made to the original files
4. Comply with all terms of the Apache License 2.0

For the complete license terms, please refer to the LICENSE file in the root
